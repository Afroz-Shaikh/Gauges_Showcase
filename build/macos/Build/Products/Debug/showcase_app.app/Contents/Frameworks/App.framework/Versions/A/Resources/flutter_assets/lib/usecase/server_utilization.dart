    ...
    return Scaffold(
      body: Center(
        child: LinearGauge(
          ...
          valueBar: [
            const ValueBar(value: 100, color: Colors.red, valueBarThickness: 40),
            ValueBar(
                value: 75, color: Colors.pink.shade300, valueBarThickness: 40),
            const ValueBar(value: 50, color: Colors.orange, valueBarThickness: 40),
            const ValueBar(value: 25, color: Colors.green, valueBarThickness: 40),
          ],
          pointers: const [
            Pointer(
                value: 75,
